...
Documentation generated from openapi.yml is [here](https://amsa-code.github.io/egc-api/) (and is updated using [`scripts/update-gh-pages.sh`](scripts/update-gh-pages.sh)). 
